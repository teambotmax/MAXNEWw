...
#==============================================================================#
                    ...
                    restartBot()
                elif msg.text in ["เอจังออน","บอทออน","โมออน"]:
                    timeNow = time.time()
                    runtime = timeNow - botStart
                    runtime = format_timespan(runtime)
                    line.sendMessage(msg.to,"✧•••❂ เวลาทำงานของบอท ❂•••✧")
                    line.sendMessage(msg.to," ❂-ՃิՁণຮี•➣Böt : 🕒 " +datetime.today().strftime('%H:%M:%S')+ "™\n{}".format(str(runtime)))
                elif msg.text in ["เอจังข้อมูล","ข้อมูลเอจัง","ข้อมูล","โมข้อมูล","ข้อมูลโม"]:
                    try:
                        arr = []
                        owner = "uec785aaa749db905a92607748dd53a99"
...
#==============================================================================#
                    ...
                    try:
                        ...
                        line.sendMessage(msg.to, str(e))
                elif msg.text in ["โมเปิดบล็อค","เปิดบล็อค"]:
                    settings["autoAdd"] = True
                    line.sendMessage(to, "✧••••••••••❂✧✯✧❂•••••••••••✧\n  เปิดระบบ Àutö Blőck: แล้วคับ\n✧••••••••••❂✧✯✧❂•••••••••••✧")
                elif msg.text in ["โมปิดบล็อค","ปิดบล็อค"]:
...
#==============================================================================#
                ...
                elif msg.text in ["เทพโม","ท่านโม"]:
                    me = line.getContact(lineMID)
                    sendMessageWithMention(to, lineMID)                 
                    line.sendContact(to, lineMID)
                    line.sendImageWithURL(msg.to,"http://dl.profile.line-cdn.net/" + me.pictureStatus) 
                elif msg.text in ["โมจัง"]:
                    sendMessageWithMention(to, lineMID)
                    line.sendContact(to, lineMID)
                    line.sendMessage(msg.to,"❂➣-ՃิՁণຮี: 🕟 " +datetime.today().strftime('%H:%M:%S')+ "➤")
...
#==========================================================================
                    ...
                    if msg._from in admin:
                            try:
                                ...
                                print (e)       
#===========================================================================
                elif msg.text in ["Allprotect on","เปิดกทม","โมกลัวตาย","เปิดระบบป้องกัน","เปิดพรบฉุกเฉิน"]:
                ...
                elif msg.text in ["Allprotect off","ปิดกทม","โมไม่กลัว","ปิดระบบป้องกัน","ปิดพรบฉุกเฉิน"]:
...
#--------------------------------------------------------------------------------------------------------------
                elif msg.text in ["โมนับจีน","นับจีน"]:
                    line.sendMessage(msg.to,"✯͜͡✯•ֆҽℓƒ-β❂T-ՃิՁণຮี•✯͜͡✯")
                    line.sendMessage(msg.to,"❂➣-รอสักครู่ค่ะ...........")
...
#------------------------------------------------------------------------------------------------------------------
                elif msg.text in ["โมนับไทย","นับไทย"]:
                    line.sendMessage(msg.to,"✥ ֆҽℓƒ-β❂T-ՃิՁণຮี ✥")
                    line.sendMessage(msg.to,"❂➣-รอสักครู่ค่ะ...........")
...
#-------------------------------------------------------------------------------------------------------------
                elif msg.text in ["โมนับอังกฤษ","นับอังกฤษ"]:
                    line.sendMessage(msg.to,"🎃 ֆҽℓƒ-β❂T-ՃิՁণຮี 🎃")
                    line.sendMessage(msg.to,"❂➣-รอสักครู่ค่ะ...........")
...
#-----------------------------------------------------------------------------------------------------------
                elif msg.text in ["โมนับอินโด","นับอินโด"]:
                    line.sendMessage(msg.to,"➤➤ ֆҽℓƒ-β❂T-ՃิՁণຮี ➤➤")
                    line.sendMessage(msg.to,"❂➣-รอสักครู่ค่ะ..................")
...
#------------------------------------------------------------------------------------------------------------
                elif msg.text in ["โมนับสเปน","นับสเปน"]:
                    line.sendMessage(msg.to,"⚽ ֆҽℓƒ-β❂T-ՃิՁণຮี ⚽")
                    line.sendMessage(msg.to,"❂➣-รอสักครู่ค่ะ...........")
                    ...
                    line.sendMessage(msg.to,"⚽ •🏆🏆🏆🏆• ⚽")
#---------------------------------------------------------------------------------------------------------------
                elif msg.text in ["โมนับไฮโซ","นับไฮโซ"]:
                    line.sendMessage(msg.to,"✧•••••••••❂✧✯✧❂••••••••••✧\n     ♡♡ HELLO KITTY ♡♡\n✧•••••••••❂✧✯✧❂••••••••••✧")
                    ...
                    for x in range(jml):
                        if 'MENTION' in msg.contentMetadata.keys()!= None:
                            ...
                            for receiver in lists:
                                ...
                                pass
#------------------------------------------------------------------------------------------------------------------
                elif msg.text.lower().startswith("โมเขียน "):
                    sep = msg.text.split(" ")
...
#------------------------------------------------------------------------------------------------------------------------
             ...
             #       ret_ += "\n•✯• ผู้สร้างกลุ่ม\n ➤ {}".format(group.id)
                ...
                elif msg.text in ["ของขวัญ","สุดหล่อแจก","ของขวัน"]:
...
#==============================================================================#
                ...
                elif msg.text in ["เปิดแสกน","โมเปิดอ่าน","เปิดสแกน","เอจังสแกน","เอจีงเปิดสแกน"]:
                    try:
                ...
                elif msg.text in ["ปิดแสกน","โมปิดอ่าน","ปิดสแกน","เอจังปิดสแกน","หยุดสแกน"]:
...
#==============================================================================#
        ...
        if op.type == 26:
            ...
            if settings ["Api"] == True:
                if msg.text in ["โม","ไอ้โม","ไอโม","เหี้ยโม","เชี้ยโม","นังโม","น้องโม","ลุงโม","ทวดโม","ตาโม"]:
                    line.sendMessage(msg.to,"●•➤ [ Auto ] ระบบฟรุ้งฟริ้ง•☆\nขณะนี้ท่านอัจฉริยะเทพโมไม่ว่างตอบ\nท่านติดธุรกิจปลาดุก100ล้าน ซอรี่..\n     A-jang@API 🕒 " +datetime.today().strftime('%H:%M:%S')+ "™\n❂ՃิՁণຮี:➣➣➣➣➣➣➣➣➣➣")
