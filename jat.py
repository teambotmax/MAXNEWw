...
RfuBot=[lineMID]
Family=["ue46731dac2bd9495d52403f78d78988b",lineMID]
admin=['ue46731dac2bd9495d52403f78d78988b',lineMID]
...
#==============================================================================#
              ...
              #      line.sendMessage(msg.to, None, contentMetadata={"STKID":"8385664","STKPKGID":"1206431","STKVER":"2"}, contentType=7)
                elif text.lower() == 'เจต1':
                    helpSet = helpset()
                    line.sendMessage(to, str(helpSet))
                    sendMessageWithMention(to, lineMID)
              #      line.sendMessage(msg.to, None, contentMetadata={"STKID":"8385664","STKPKGID":"1206431","STKVER":"2"}, contentType=7)
                elif text.lower() == 'เจต2':
                    listGrup = listgrup()
                    line.sendMessage(to, str(listGrup))
              #      line.sendMessage(msg.to, None, contentMetadata={"STKID":"8385664","STKPKGID":"1206431","STKVER":"2"}, contentType=7)
                elif text.lower() == 'เจต3':
                    helpSetting = helpsetting()
                    line.sendMessage(to, str(helpSetting))
              #      line.sendMessage(msg.to, None, contentMetadata={"STKID":"8385664","STKPKGID":"1206431","STKVER":"2"}, contentType=7)
                elif text.lower() == 'เจต4':
                    socMedia = socmedia()
                    line.sendMessage(to, str(socMedia))
              #      line.sendMessage(msg.to, None, contentMetadata={"STKID":"8385664","STKPKGID":"1206431","STKVER":"2"}, contentType=7)
                elif text.lower() == 'เจต5':
                    helpTextToSpeech = helptexttospeech()
                    line.sendMessage(to, str(helpTextToSpeech))
              #      line.sendMessage(msg.to, None, contentMetadata={"STKID":"8385664","STKPKGID":"1206431","STKVER":"2"}, contentType=7)
                elif text.lower() == 'เจต6':
...
#==============================================================================#
                    ...
                    restartBot()
                elif msg.text in ["เจตออน","บอทออน","โมออน"]:
                    timeNow = time.time()
                    runtime = timeNow - botStart
                    runtime = format_timespan(runtime)
                    line.sendMessage(msg.to,"✧•••❂ เวลาทำงานของบอท ❂•••✧")
                    line.sendMessage(msg.to," ❂-ՃิՁণຮี•➣Böt : 🕒 " +datetime.today().strftime('%H:%M:%S')+ "™\n{}".format(str(runtime)))
                elif msg.text in ["เอจังข้อมูล","ข้อมูลเอจัง","ข้อมูล","เจตข้อมูล","ข้อมูลเจต"]:
                    try:
                        arr = []
                        owner = "ue46731dac2bd9495d52403f78d78988b"
...
#==============================================================================#
                    ...
                    try:
                        ...
                        line.sendMessage(msg.to, str(e))
                elif msg.text in ["เจตเปิดบล็อค","เปิดบล็อค"]:
                    settings["autoAdd"] = True
                    line.sendMessage(to, "✧••••••••••❂✧✯✧❂•••••••••••✧\n  เปิดระบบ Àutö Blőck: แล้วคับ\n✧••••••••••❂✧✯✧❂•••••••••••✧")
                elif msg.text in ["เจตปิดบล็อค","ปิดบล็อค"]:
...
#==============================================================================#
                    ...
                    sendMessageWithMention(to, lineMID)
                    line.sendMessage(msg.to,"✯::: ♡•สเตตัสนะคับ•♡ :::✯\n" + me.statusMessage)
                ...
                elif msg.text in ["คุณเจต","เทพเจต"]:
                    me = line.getContact(lineMID)
                    sendMessageWithMention(to, lineMID)                 
                    line.sendContact(to, lineMID)
                    line.sendImageWithURL(msg.to,"http://dl.profile.line-cdn.net/" + me.pictureStatus) 
                    ...
                    sendMessageWithMention(to, lineMID)
                    line.sendContact(to, "ue46731dac2bd9495d52403f78d78988b")
                    ...
                    line.sendMessage(msg.to,"✯::: ♡•วีดีโอคนน่ารักคับ•♡ :::✯")
                    me = line.getContact(lineMID)
...
#==========================================================================
                    ...
                    if msg._from in admin:
                            try:
                                ...
                                print (e)       
#===========================================================================
                elif msg.text in ["Allprotect on","เปิดกทม","เจตกลัวตาย","เปิดระบบป้องกัน","เปิดพรบฉุกเฉิน"]:
                ...
                elif msg.text in ["Allprotect off","ปิดกทม","เจตไม่กลัว","ปิดระบบป้องกัน","ปิดพรบฉุกเฉิน"]:
...
#--------------------------------------------------------------------------------------------------------------
                elif msg.text in ["เจตนับจีน","นับจีน"]:
                    line.sendMessage(msg.to,"✯͜͡✯•ֆҽℓƒ-β❂T-ՃิՁণຮี•✯͜͡✯")
                    line.sendMessage(msg.to,"❂➣-รอสักครู่ค่ะ...........")
...
#------------------------------------------------------------------------------------------------------------------
                elif msg.text in ["เจตนับไทย","นับไทย"]:
                    line.sendMessage(msg.to,"✥ ֆҽℓƒ-β❂T-ՃิՁণຮี ✥")
                    line.sendMessage(msg.to,"❂➣-รอสักครู่ค่ะ...........")
...
#-------------------------------------------------------------------------------------------------------------
                elif msg.text in ["เจตนับอังกฤษ","นับอังกฤษ"]:
                    line.sendMessage(msg.to,"🎃 ֆҽℓƒ-β❂T-ՃิՁণຮี 🎃")
                    line.sendMessage(msg.to,"❂➣-รอสักครู่ค่ะ...........")
...
#-----------------------------------------------------------------------------------------------------------
                elif msg.text in ["เจตนับอินโด","นับอินโด"]:
                    line.sendMessage(msg.to,"➤➤ ֆҽℓƒ-β❂T-ՃิՁণຮี ➤➤")
                    line.sendMessage(msg.to,"❂➣-รอสักครู่ค่ะ..................")
...
#------------------------------------------------------------------------------------------------------------
                elif msg.text in ["เจตนับสเปน","นับสเปน"]:
                    line.sendMessage(msg.to,"⚽ ֆҽℓƒ-β❂T-ՃิՁণຮี ⚽")
                    line.sendMessage(msg.to,"❂➣-รอสักครู่ค่ะ...........")
                    ...
                    line.sendMessage(msg.to,"⚽ •🏆🏆🏆🏆• ⚽")
#---------------------------------------------------------------------------------------------------------------
                elif msg.text in ["เจตนับไฮโซ","นับไฮโซ"]:
                    line.sendMessage(msg.to,"✧•••••••••❂✧✯✧❂••••••••••✧\n     ♡♡ HELLO KITTY ♡♡\n✧•••••••••❂✧✯✧❂••••••••••✧")
...
#-----------------------------------------------------------------------------------------------------------------
                    ...
                    line.sendMessage(msg.to,"❂➣-ՃิՁণຮี: 🕟 " +datetime.today().strftime('%H:%M:%S')+ "➤")
                    line.sendContact(to, "ue46731dac2bd9495d52403f78d78988b")
                    line.sendMessage(msg.to,"👆• คนนี้นะครับ by : เจต™ •👆")
#---------------------------------------------------------------------------------------------------------------
                elif msg.text in ["เจตopen"]:
                    line.sendMessage(msg.to,"✯::[[[ เปิดระบบเรียบร้อยคับ ]]]::✯\n A~jańg@Opën 🕒 " +datetime.today().strftime('%H:%M:%S')+ "™")
                elif msg.text in ["เจตclose"]:
                    line.sendMessage(msg.to,"✯::[[[ ปิดระบบเรียบร้อยคับ ]]]::✯\nA~jańg@Clöse 🕒 " +datetime.today().strftime('%H:%M:%S')+ "™")
                elif msg.text in ["ชิวารีออน"]:
                    line.sendMessage(msg.to,"✧•••❂ เวลาทำงานของบอท ❂•••✧")
                    line.sendMessage(msg.to," ❂-ՃิՁণຮี•➣Böt : 🕒 " +datetime.today().strftime('%H:%M:%S')+ "™\n╔•➤➤➤➤➤➤➤➤➤➤➤➤➤\n╠  Ä☆➣   1 ปี\n╠  ••••••Ä☆➣  765 ชั่วโมง\n╠  •••••••••••••Ä☆➣   908   นาที\n╚•➤➤➤➤➤➤➤➤➤➤➤➤➤")
#----------------------------------------------------------------------------------------------------------------
                elif msg.text in ["เจตด่า"]:
                    ...
                    for x in range(jml):
                        if 'MENTION' in msg.contentMetadata.keys()!= None:
                            ...
                            for receiver in lists:
                                ...
                                pass
#------------------------------------------------------------------------------------------------------------------
                elif msg.text.lower().startswith("เจตเขียน "):
                    sep = msg.text.split(" ")
...
#------------------------------------------------------------------------------------------------------------------------
             ...
             #       ret_ += "\n•✯• ผู้สร้างกลุ่ม\n ➤ {}".format(group.id)
                ...
                if "gift " in msg.text.lower():
                    ...
                    line.sendMessage(msg)
#==============================================================================#
                elif msg.text in ["เจตแทค","เจตแทก"]:
                    group = line.getGroup(msg.to)
...
#==============================================================================#
                ...
                elif msg.text in ["เปิดแสกน","เจตเปิดอ่าน","เปิดสแกน","เอจังสแกน","เอจีงเปิดสแกน"]:
                    try:
                ...
                elif msg.text in ["ปิดแสกน","เจตปิดอ่าน","ปิดสแกน","เอจังปิดสแกน","หยุดสแกน"]:
...
#==============================================================================#
        ...
        if op.type == 26:
            ...
            if settings ["Api"] == True:
                if msg.text in ["เจต","ลุงเจต","ทวดเจต","ไอเจต","ดอเจต","ไอ้เจต""น้องเจต","เหี้ยเจต","ควยเจต"]:
                    line.sendMessage(msg.to,"●•➤ [ Auto ] ระบบฟรุ้งฟริ้ง•☆\nไม่ว่างครับม่อสาวอยู่ ขออภัย\n     A-jang@API 🕒 " +datetime.today().strftime('%H:%M:%S')+ "™\n❂ՃิՁণຮี:➣➣➣➣➣➣➣➣➣➣")
        #            line.sendMessage(msg.to, None, contentMetadata={"STKID":"49353551","STKPKGID":"11286","STKVER":"1"}, contentType=7)
          ...
          #          line.sendMessage(msg.to, None, contentMetadata={"STKID":"","STKPKGID":"1356533","STKVER":"2"}, contentType=7)
            ...
            if settings ["Api"] == True:
                if msg.text in ["หล่อ","หล่อมาก","น่ารักโคตร","โคตรน่ารัก","น่ารักฝุด","น่ารัก","น่ารักอะ","น่ารักอ่ะ"]:
            ...
            if settings ["Api"] == True:
                if msg.text in ["บอท","คนหรือบอท","บอทหรอ","คนหรอบอท","บอทป่าว","บอทป่ะ","เชล","เชลบอท","บอทตาย"]:
