...
#line = LINE()
#line = LINE("เมล","พาส")
line = LINE('EuYfTUY4e27s0Wag3yH3.TAVOkm2wqPizxdXz1JiGmW.u0TH/vbWGn25ketAooX4T9D8P85j8YQcrE9pS6FzmAo=')
line.log("Auth Token : " + str(line.authToken))
line.log("Timeline Token : " + str(line.tl.channelAccessToken))

ki = LINE('EuvnJpyTkGJwDaNuHekc.ovqvmfGzvKpMHoOPQ4Gpta.clRzPNcqn6rl+L2hJs2z43IGL+1bbws+j4sMHJLw0A0=')
ki.log("Auth Token : " + str(ki.authToken))
ki.log("Timeline Token : " + str(ki.tl.channelAccessToken))

kk = LINE('EuJYu9bjUUaGjVIKFWIc.Q9DC+bYJIZLrFrpcIAmSda.RRUwW53fvAoAQb7+3yhYGhz7eLAKcsJNgOYCnOuMfvw=')
kk.log("Auth Token : " + str(kk.authToken))
kk.log("Timeline Token : " + str(kk.tl.channelAccessToken))

kc = LINE('EutSCQzvFb01pVtrNzc3.FXP8F/ZJ0UQHfIxYmKf0iW.jLPLDV8EKTKQjmnl7iuVizoMNi3PopD/a3aTEh5zDfA=')
kc.log("Auth Token : " + str(kc.authToken))
kc.log("Timeline Token : " + str(kc.tl.channelAccessToken))

ke = LINE('Eu0Le2jAa4YzHr8t46ud.MJjB5RM02td4rFyvdkvFtq.i5iAKhUGrkdJgl1oYEGJVidsVv9YpVk0YACB1yEiIi0=')
