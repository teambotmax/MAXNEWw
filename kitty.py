...
#==============================================================================#
              ...
              #      line.sendMessage(msg.to, None, contentMetadata={"STKID":"8385664","STKPKGID":"1206431","STKVER":"2"}, contentType=7)
                elif text.lower() == 'สมุน1':
                    helpSet = helpset()
                    line.sendMessage(to, str(helpSet))
                    sendMessageWithMention(to, lineMID)
              #      line.sendMessage(msg.to, None, contentMetadata={"STKID":"8385664","STKPKGID":"1206431","STKVER":"2"}, contentType=7)
                elif text.lower() == 'สมุน2':
                    listGrup = listgrup()
                    line.sendMessage(to, str(listGrup))
              #      line.sendMessage(msg.to, None, contentMetadata={"STKID":"8385664","STKPKGID":"1206431","STKVER":"2"}, contentType=7)
                elif text.lower() == 'สมุน3':
                    helpSetting = helpsetting()
                    line.sendMessage(to, str(helpSetting))
              #      line.sendMessage(msg.to, None, contentMetadata={"STKID":"8385664","STKPKGID":"1206431","STKVER":"2"}, contentType=7)
                elif text.lower() == 'สมุน4':
                    socMedia = socmedia()
                    line.sendMessage(to, str(socMedia))
              #      line.sendMessage(msg.to, None, contentMetadata={"STKID":"8385664","STKPKGID":"1206431","STKVER":"2"}, contentType=7)
                elif text.lower() == 'สมุน5':
                    helpTextToSpeech = helptexttospeech()
                    line.sendMessage(to, str(helpTextToSpeech))
              #      line.sendMessage(msg.to, None, contentMetadata={"STKID":"8385664","STKPKGID":"1206431","STKVER":"2"}, contentType=7)
                elif text.lower() == 'สมุน6':
...
#==============================================================================#
                ...
                elif msg.text in ["เอจังข้อมูล","ข้อมูลเอจัง","ข้อมูล"]:
                    try:
                        arr = []
...
#==============================================================================#
                    ...
                    try:
                        ...
                        line.sendMessage(msg.to, str(e))
                elif msg.text in ["เอจังเปิดบล็อค","เปิดบล็อค"]:
                    settings["autoAdd"] = True
                    line.sendMessage(to, "✧••••••••••❂✧✯✧❂•••••••••••✧\n  เปิดระบบ Àutö Blőck: แล้วค่ะ\n✧••••••••••❂✧✯✧❂•••••••••••✧")
                elif msg.text in ["เอจังปิดบล็อค","ปิดบล็อค"]:
                    ...
                    line.sendMessage(to, "✯:: เปิดระบบเสือกเรียบร้อยค่ะ ::✯")
                elif msg.text in ["ปิดเสือก"]:
                    settings["unsendMessage"] = False
                    line.sendMessage(to, "unsëndMessage : off •➣➣")
                    line.sendMessage(to, "✯:: ปิดระบบเสือกเรียบร้อยค่ะ ::✯")           
#==============================================================================#
                    ...
                    line.sendMessage(msg.to,"✯::: ♡•ไอดีคนน่ารักค่ะ•♡ ::✯\n" +  lineMID)
                elif msg.text in ["ชื่อกู"]:
                    me = line.getContact(lineMID)
                    line.sendMessage(msg.to,"✯::: ♡•ชื่อคนน่ารักค่ะ•♡ :::✯\n" + me.displayName)
                elif msg.text in ["ตัสกู"]:
                    me = line.getContact(lineMID)
                    line.sendMessage(msg.to,"✯::: ♡•สเตตัสคนน่ารักค่ะ•♡ :::✯\n" + me.statusMessage)
...
#==============================================================================#
                    ...
                    if mic == "on":
                        if settings["mimic"]["status"] == False:
                            ...
                            line.sendMessage(msg.to,"✯::[[[ ®-เปิดสกิลเลียนแบบค่ะ ]]]::✯")
                    elif mic == "off":
                        if settings["mimic"]["status"] == True:
                            settings["mimic"]["status"] = False
                            line.sendMessage(msg.to,"✯::[[[ ®-ปิดสกิลเลียนแบบค่ะ ]]]::✯")
#---------------------------------------------------------------------------------------------------------------------------------+                     
...
#==========================================================
                elif msg.text in ["กู","เอ","สุดสวย","เอจัง","คนน่ารัก"]:
                    line.sendContact(to, lineMID)
                    line.sendMessage(msg.to,"❂➣-ՃิՁণຮี: 🕟 " +datetime.today().strftime('%H:%M:%S')+ "➤")
#------------------------------------------------------------------------------------------------------------
                elif msg.text in ["สวยสุด","นายก","นุ้ย","นมโต","นุ่ย","คนสวย"]:
                    line.sendContact(to, lineMID)
...
#------------------------------------------------------------------------------------------------------------------------
             ...
             #       ret_ += "\n•✯• ผู้สร้างกลุ่ม\n ➤ {}".format(group.id)
                ...
                if "gift " in msg.text.lower():
                    ...
                    line.sendMessage(msg)
#==============================================================================#
                elif msg.text in ["เอจังแทค","เอจังแทก"]:
...
#==============================================================================#
        ...
        if op.type == 26:
            ...
            if settings ["Api"] == True:
                if msg.text in ["เอ","ป้า","ป้าเอ","เอจัง","ชิวารี","น้องเอ","เลียขา","เลขา","ยัยเอ","เขียว","ไอ้เขียว","ไอเขีบว"]:
                    line.sendMessage(msg.to,"●•➤ [ Auto ] ระบบฟรุ้งฟริ้ง•☆\nขณะนี้ท่านอัจฉริยะเอจังไม่ว่างตอบ\nท่านติดธุรกิจปลากัด100ล้าน ซอรี่..\n     A-jang@API 🕒 " +datetime.today().strftime('%H:%M:%S')+ "™\n❂ՃิՁণຮี:➣➣➣➣➣➣➣➣➣➣")
            if settings ["Api"] == True:
          ...
          #          line.sendMessage(msg.to, None, contentMetadata={"STKID":"","STKPKGID":"1356533","STKVER":"2"}, contentType=7)
            ...
            if settings ["Api"] == True:
                if msg.text in ["สต","สต.","ส.ต."]:
                    line.sendMessage(msg.to," ✥✥✥ ส้นตีนหรอค่ะ ✥✥✥\nA~jańg@Api 🕒 " +datetime.today().strftime('%H:%M:%S')+ "™")
            if settings ["Api"] == True:
            ...
            if settings ["Api"] == True:
                if msg.text in ["555","5555","55555","555+","ขำ"]:
                    line.sendMessage(msg.to,"❂•หุบปากบ้างลมมันโชยค่ะ•❂\n A~jańg@Api 🕒 " +datetime.today().strftime('%H:%M:%S')+ "™")
            if settings ["Api"] == True:
            ...
            if settings ["Api"] == True:
                if msg.text in ["Rov","rov","Mvp","mvp","แรงค์","ลงแรงค์","หาคนแบก","เก็บรอบ","แร้งค์",]:
                    line.sendMessage(msg.to,"❂•เล่นอยู่ได้ ไม่เบื่อบ้างหราค่ะ•❂\n   A~jang@API 🕒 " +datetime.today().strftime('%H:%M:%S')+ "™")
            if settings ["Api"] == True:
                if msg.text in ["รนก","รนก."]:
                    line.sendMessage(msg.to,"✥✥• รักน้องก้อยหราค่ะ •✥✥\n A~jang@Api 🕒 " +datetime.today().strftime('%H:%M:%S')+ "™")
            if settings ["Api"] == True:
                if msg.text in ["ขอบคุนค่ะ","ขอบคุนครับ","ขอบคุนคับ","ขอบคุนคะ","ขอบคุณ","ขอบคุน","ขอบใจ","ขอบคุณคับ","ขอบคุณคะ","ขอบคุณค่ะ","ใจจ้า","ดีคับ","ดีค่ะ","ดีคร้า","ดีค้าบ","ดีค้าฟ","มอนิ้ง","มอนิ่ง","ขอบคุณมาก","ขอบคุนมาก","ดียามเช้า","อรุณสวัสดิ์"," ดีจ้า"]:
                    line.sendMessage(msg.to,"❂•• กองไว้ตรงนั้นค่ะ ••❂\n  Auto® 🕞 " +datetime.today().strftime('%H:%M:%S')+ "™")
            if settings ["Api"] == True:
                if msg.text in ["ดำ"]:
                    line.sendMessage(msg.to,"❂•เอากระดาษทรายมาขัดสิค่ะ•❂\n ®A~jańg@API 🕒 " +datetime.today().strftime('%H:%M:%S')+ "™")
            if settings ["Api"] == True:
            ...
            if settings ["Api"] == True:
                if msg.text in ["เยส","เยสสส","เยสส","เยสสสสส","เยสสสส","เงี่ยน","เงี่ยนชิบ","เงี่ยนโว้ย","เงี่ยนโว้ยยย","เงี่ยนวะ","กูเงี่ยน","เงี่ยนเว้ย"]:
                    line.sendMessage(msg.to,"❂❂•ก็ไปเยสกับรถถังสิค่ะ•❂❂\n A~jańg@Api 🕒 " +datetime.today().strftime('%H:%M:%S')+ "™")
            if settings ["Api"] == True:
                if msg.text in ["บอท","Bot","bot","คนหรือบอท","บอทหรอ","คนหรอบอท","บอทป่าว","บอทป่ะ","เชล","เชลบอท","บอทตาย"]:
                    line.sendMessage(msg.to,"❂•เรื่องบอทญาญ่าจะไม่ยุ่งค่ะ•❂\n   A~jańg@Api 🕒 " +datetime.today().strftime('%H:%M:%S')+ "™")
            if settings ["Api"] == True:
            ...
            if settings ["Api"] == True:
                if msg.text in ["ดึง","ฝากดึง","ดึงที","ฝากดึงที","ดึงหน่อย"]:
                    line.sendMessage(msg.to,"❂•ไม่ดึงนะค่ะ ไม่อยากรู้จัก•❂\n A~jańg@Api 🕒 " +datetime.today().strftime('%H:%M:%S'))
            if settings ["Api"] == True:
            ...
            if settings ["Api"] == True:
                if msg.text in ["จี้ใหม่","คิวปิด","ไมอา"]:
                    line.sendMessage(msg.to,"❂•นั่งดูพวกบร้าเกมส์คุยกันค่ะ•❂\n   A~jańg@Api 🕒 " +datetime.today().strftime('%H:%M:%S')+ "™")
