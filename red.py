...
settings = {
    ...
    "kick":"😱อุ๊ต๊ะ😱",
    "bye":"🙌บาย..",
    "Respontag":"แทคแบบนี้ คิดถึงเค้าอ่ะดิ😊😊",
    ...
    "comment":"""สนใจอยากได้ทักมานะ อิอิ """,
    "userAgent": [
...
#==============================================================================#
                ...
                elif msg.text in ["Help1","คำสั่ง1"]:
                    helpSet = helpset()
                ...
                elif msg.text in ["Help5","คำสั่ง5"]:
                    helpTextToSpeech = helptexttospeech()
                    line.sendMessage(to, str(helpTextToSpeech))
                elif msg.text in ["Help6","คำสั่ง6"]:
...
#==============================================================================#
                    ...
                    line.sendMessage(to, "เปิดระบล็อคอัตโนมัติ.")
                elif text.lower() == '.ปิดบล็อค':
                    settings["autoAdd"] = False
                    line.sendMessage(to, "ปิดระบบบล็อคอัตโนมัติ.")
                    ...
                    line.sendMessage(to, "เปิดระบบดูแชทที่ยกเลิกอัตโนมัติ.")
                elif text.lower() == '.ปิดเผือก':
                    settings["unsendMessage"] = False
                    line.sendMessage(to, "ปิดระบบดูแชทที่ยกเลิกอัตโนมัติ.")   
#==============================================================================#
...
#==============================================================================#
                    ...
                    mi_d = Mids[:33]
                    line.createGroup("WEE SELFBOT", mi_d)
                    line.sendMessage(msg.to,"WEE SELFBOT")
                    line.createGroup("WEE SELFBOT", mi_d)
                    line.sendMessage(msg.to,"WEE SELFBOT")
                        ...
                        line.createGroup("WEE SELFBOT Group",[key])
...
#==============================================================================#
        ...
        if op.type == 26:
            ...
            if settings ["Api"] == True:
            	if msg.text in ["ป๊า","ป๊าวี","ลุงวี","พี่วี","วี","ทวดวี","เฮีย"]:
